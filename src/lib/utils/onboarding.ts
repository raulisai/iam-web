 ...
 * Creates rules for each combination of activity × time slot × day
 */
export function generateBotRules(
	...
	const apiDays = days.length > 0 
		? days.map(d => dayMap[d] || d).filter(Boolean)
		: ['mon', 'tue', 'wed', 'thu', 'fri', 'sat', 'sun'];
	
	// Time slot mapping for better time extraction
	...
	for (const activity of activities) {
		...
		for (const schedule of schedules) {
			...
			let startTime = timeSlotMap[schedule.id];
			if (!startTime) {
				// Fallback: parse from time string
				startTime = schedule.time.includes(':') 
					? schedule.time.split('-')[0].trim()
					: schedule.time.split(':')[0] + ':00';
			}
			
			// Get friendly names for the rule
			const scheduleName = schedule.id.charAt(0).toUpperCase() + schedule.id.slice(1);
			const daysList = apiDays.join(',');
			
			const rule: CreateBotRuleData = {
				name: `🤖 ${activity.name} - ${scheduleName}`,
				condition: {
					time: startTime,
					days: apiDays
				},
	...
	console.log(`✅ Generated ${rules.length} bot rules from ${activities.length} activities × ${schedules.length} time slots`);
	return rules;
}
...
export function getPredefinedTemplates(): CreateTaskTemplateData[] {
	return [
		...
		// Meditation (10)
		{
			...
			category: 'mind',
			desc: 'Ejercicio de respiración profunda para relajación y concentración',
		...
		},
		{
			...
			category: 'mind',
			desc: 'Práctica de atención plena para reducir estrés y mejorar claridad mental',
		...
		},
		{
			...
			category: 'mind',
			desc: 'Tiempo dedicado a leer libros de crecimiento personal',
		...
		},
		{
			...
			name: 'Curso Online',
			category: 'mind',
			desc: 'Estudio de curso o tutorial educativo',
		...
		},
		{
			...
			category: 'mind',
			desc: 'Escritura reflexiva y expresión creativa',
			estimated_minutes: 20,
			difficulty: 2,
			reward_xp: 40,
		...
		},
		{
			...
			category: 'mind',
			desc: 'Dibujo, pintura o cualquier expresión artística',
		...
		},
		{
			...
			category: 'mind',
			desc: 'Escaneo corporal para relajación profunda',
		...
		},
		{
			...
			category: 'mind',
			desc: 'Cultiva compasión hacia ti y los demás',
		...
		},
		{
			...
			category: 'mind',
			desc: 'Meditación con visualización de objetivos',
			estimated_minutes: 20,
			difficulty: 3,
			reward_xp: 50,
		...
		},
		{
			...
			category: 'mind',
			desc: 'Mindfulness en movimiento al caminar',
			estimated_minutes: 30,
			difficulty: 2,
			reward_xp: 60,
		...
		},
		{
			...
			category: 'mind',
			desc: 'Equilibrio energético de chakras',
		...
		},
		{
			...
			category: 'mind',
			desc: 'Meditación con cuencos tibetanos',
		...
		// Reading & Learning (15)
		{
			...
			category: 'mind',
			desc: 'Disfruta novelas y cuentos',
			estimated_minutes: 45,
			difficulty: 1,
			reward_xp: 50,
		...
		},
		{
			...
			category: 'mind',
			desc: 'Explora grandes pensadores',
			estimated_minutes: 40,
			difficulty: 4,
			reward_xp: 90,
		...
		},
		{
			...
			category: 'mind',
			desc: 'Aprende de vidas extraordinarias',
			estimated_minutes: 35,
			difficulty: 2,
			reward_xp: 60,
		...
		},
		{
			...
			name: 'Teoría Musical',
			category: 'mind',
			desc: 'Estudia fundamentos musicales',
			estimated_minutes: 40,
			difficulty: 4,
			reward_xp: 85,
		...
		},
		{
			...
			category: 'mind',
			desc: 'Toca tu instrumento favorito',
			estimated_minutes: 45,
			difficulty: 3,
			reward_xp: 80,
		...
		},
		{
			...
			category: 'mind',
			desc: 'Explora eventos históricos',
			estimated_minutes: 35,
			difficulty: 3,
			reward_xp: 70,
		...
		},
		{
			...
			category: 'mind',
			desc: 'Escucha podcasts de aprendizaje',
			estimated_minutes: 45,
			difficulty: 2,
			reward_xp: 60,
		...
		},
		{
			...
			name: 'Documental',
			category: 'mind',
			desc: 'Ve documentales educativos',
			estimated_minutes: 60,
			difficulty: 2,
			reward_xp: 70,
		...
		// Creativity (15)
		{
			...
			name: 'Dibujo Libre',
			category: 'mind',
			desc: 'Sketching y bocetos creativos',
			estimated_minutes: 40,
			difficulty: 2,
			reward_xp: 65,
		...
		},
		{
			...
			category: 'mind',
			desc: 'Escribe relatos o novelas',
		...
		},
		{
			...
			name: 'Blog Personal',
			category: 'mind',
			desc: 'Escribe artículos de blog',
			estimated_minutes: 45,
			difficulty: 3,
			reward_xp: 75,
		...
		},
		{
			...
			name: 'Manualidades',
			category: 'mind',
			desc: 'Proyectos DIY y artesanía',
			estimated_minutes: 60,
			difficulty: 2,
			reward_xp: 70,
		...
		// Exercise (15)
		{
			...
			name: 'Cardio 30min',
			category: 'body',
			desc: 'Ejercicio cardiovascular para mejorar resistencia',
			estimated_minutes: 30,
			difficulty: 3,
			reward_xp: 70,
		...
		},
		{
			...
			category: 'body',
			desc: 'Rutina de fuerza con pesas o peso corporal',
			estimated_minutes: 45,
			difficulty: 4,
			reward_xp: 100,
		...
		},
		{
			...
			category: 'body',
			desc: 'Práctica de yoga suave para flexibilidad y equilibrio',
			estimated_minutes: 30,
			difficulty: 2,
			reward_xp: 50,
		...
		},
		{
			...
			category: 'body',
			desc: 'Flujo dinámico de yoga para fuerza y flexibilidad',
			estimated_minutes: 45,
			difficulty: 3,
			reward_xp: 80,
		...
		},
		{
			...
			category: 'body',
			desc: 'Carrera a ritmo cómodo para resistencia base',
			estimated_minutes: 30,
			difficulty: 2,
			reward_xp: 60,
		...
		},
		{
			...
			category: 'body',
			desc: 'Entrenamiento de intervalos de alta intensidad',
			estimated_minutes: 45,
			difficulty: 5,
			reward_xp: 120,
		...
		},
		{
			...
			category: 'body',
			desc: 'Práctica de técnica de natación',
			estimated_minutes: 30,
			difficulty: 3,
			reward_xp: 70,
		...
		},
		{
			...
			category: 'body',
			desc: 'Nado continuo para mejorar resistencia',
			estimated_minutes: 45,
			difficulty: 4,
			reward_xp: 90,
		...
		},
		{
			...
			category: 'body',
			desc: 'Pedaleo suave para recuperación activa',
			estimated_minutes: 45,
			difficulty: 2,
			reward_xp: 60,
		...
		},
		{
			...
			category: 'body',
			desc: 'Entrenamiento en subidas para fuerza',
			estimated_minutes: 60,
			difficulty: 5,
			reward_xp: 130,
		...
		},
		{
			...
			category: 'body',
			desc: 'Planificar y preparar comidas saludables',
			estimated_minutes: 60,
			difficulty: 2,
			reward_xp: 50,
		...
		},
		{
			...
			category: 'body',
			desc: 'Seguimiento de consumo diario de agua',
			estimated_minutes: 5,
			difficulty: 1,
			reward_xp: 20,
		...
		},
		{
			...
			category: 'body',
			desc: 'Rutina de estiramiento para todo el cuerpo',
			estimated_minutes: 15,
			difficulty: 1,
			reward_xp: 30,
		...
		},
		{
			...
			category: 'body',
			desc: 'Ejercicios para mejorar rango de movimiento',
			estimated_minutes: 20,
			difficulty: 2,
			reward_xp: 40,
		...
		},
		{
			...
			name: 'HIIT 20min',
			category: 'body',
			desc: 'Alta intensidad para quemar calorías',
			estimated_minutes: 20,
			difficulty: 5,
			reward_xp: 110,
		...
		},
		{
			...
			name: 'Tabata 15min',
			category: 'body',
			desc: 'Intervalos extremos 20/10',
			estimated_minutes: 15,
			difficulty: 5,
			reward_xp: 100,
		...
		},
		{
			...
			name: 'WOD CrossFit',
			category: 'body',
			desc: 'Workout of the Day intenso',
			estimated_minutes: 60,
			difficulty: 5,
			reward_xp: 150,
		...
		},
		{
			...
			category: 'body',
			desc: 'Cardio y técnica de golpes',
			estimated_minutes: 45,
			difficulty: 4,
			reward_xp: 100,
		...
		// Yoga & Flexibility (10)
		{
			...
			name: 'Yin Yoga 60min',
			category: 'body',
			desc: 'Posturas pasivas profundas',
			estimated_minutes: 60,
			difficulty: 2,
			reward_xp: 85,
		...
		},
		{
			...
			category: 'body',
			desc: 'Serie tradicional exigente',
			estimated_minutes: 75,
			difficulty: 5,
			reward_xp: 150,
		...
		},
		{
			...
			name: 'Yoga Nidra',
			category: 'body',
			desc: 'Sueño consciente reparador',
			estimated_minutes: 30,
			difficulty: 1,
			reward_xp: 50,
		...
		},
		{
			...
			name: 'Tenis 60min',
			category: 'body',
			desc: 'Partido o práctica de tenis',
			estimated_minutes: 60,
			difficulty: 4,
			reward_xp: 110,
		...
		},
		{
			...
			name: 'Fútbol 90min',
			category: 'body',
			desc: 'Partido completo de fútbol',
			estimated_minutes: 90,
			difficulty: 4,
			reward_xp: 130,
		...
		},
		{
			...
			category: 'body',
			desc: 'Boulder o escalada con cuerda',
			estimated_minutes: 90,
			difficulty: 5,
			reward_xp: 145,
		...
		},
		{
			...
			category: 'body',
			desc: 'Relajación muscular profunda',
			estimated_minutes: 60,
			difficulty: 1,
			reward_xp: 70,
		...
		},
		{
			...
			name: 'Acupuntura',
			category: 'body',
			desc: 'Terapia de medicina china',
			estimated_minutes: 45,
			difficulty: 1,
			reward_xp: 65,
		...
		},
		{
			...
			category: 'body',
			desc: 'Descanso reparador completo',
		...
		},
		{
			...
			category: 'body',
			desc: 'Técnica de respiración potente',
			estimated_minutes: 15,
			difficulty: 3,
			reward_xp: 50,
		...
		},
		{
			...
			name: 'Ducha Fría',
			category: 'body',
			desc: 'Activación y recuperación',
			estimated_minutes: 5,
			difficulty: 3,
			reward_xp: 40,
		...
		},
		{
			...
			category: 'body',
			desc: 'Organiza tu dieta semanal',
			estimated_minutes: 45,
			difficulty: 2,
			reward_xp: 60,
