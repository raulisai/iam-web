    ...
    <div class="flex-1 flex flex-col max-w-5xl mx-auto w-full">
        ...
        <div class="border-t border-white/10 px-8 py-6">
            ...
            <div class="flex gap-3 mb-4">
                <button class="px-4 py-2 rounded-lg bg-neutral-900/60 border border-white/10 text-sm text-white/70 whitespace-nowrap hover:bg-neutral-900 transition-colors">
                    📊 Analyze my progress
                </button>
                <button class="px-4 py-2 rounded-lg bg-neutral-900/60 border border-white/10 text-sm text-white/70 whitespace-nowrap hover:bg-neutral-900 transition-colors">
                    💡 Suggest improvements
