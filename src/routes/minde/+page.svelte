...
<!-- Opcional: placeholder en escritorio -->
<div class="hidden md:flex items-center justify-center h-screen text-neutral-400">
    <p>Esta vista está optimizada para móvil.</p>
